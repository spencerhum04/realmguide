<script lang="ts" setup>
    ...
    const exalts = [
        ...
        { potion: "/potion-defense.png", dungeon1: "/dungeon-lost-halls.png", boss1: "/enemy-marble-colossus.png" },
...
<template>
    <div className="flex flex-col gap-y-20 bg-light-sand">
        ...
        <div class="flex flex-col items-center bg-light-sand w-full min-h-screen justify-center px-10 text-center py-10">
        ...
        <div class="flex flex-col items-center gap-y-16 bg-light-sand w-full min-h-screen justify-center py-10">
            <div class="text-5xl font-semibold text-center">Discover What's New</div>
            ...
            <NuxtLink
                ...
                class="text-blood-red font-medium hover:underline cursor-pointer">View more resources
            </NuxtLink>
        </div>
